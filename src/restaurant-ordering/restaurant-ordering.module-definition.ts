...
function buildBusinessRulesLines(): string[] {
  return [
    ...
    '- Présenter un récap complet avant confirmation (items + options, mode, adresse/quartier si livraison, sous-total, frais, total, note) — ask_order_confirmation le formate pour les boutons.',
...
const OPENAI_STYLE_DIRECTIVES = [
  ...
  'Bonne réponse : appeler set_delivery_info avec « Point E, à côté d’Auchan 1 », puis enchaîner vers ask_order_confirmation si tout est prêt.',
  '',
